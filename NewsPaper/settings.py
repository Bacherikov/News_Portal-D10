...
SECRET_KEY = 'django-insecure-&$i3yemoo&i=d%ld3&hid+cz)c0cd#8_o@c%iukvt&*j3++7dy'
...
# LOGIN_URL = '/sign/login/' закоментил из-за 10.1
LOGIN_URL = '/accounts/login/'  # 10.1 добавлено для пакета allauth
LOGIN_REDIRECT_URL = '/'
...
EMAIL_HOST_PASSWORD = 'gqygnskezrymvjns'  # пароль от приложения
